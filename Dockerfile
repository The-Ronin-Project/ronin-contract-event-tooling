...
ADD --chown=ronin ./ronin-contract-event-plugin/build/initializer /usr/local/initializer
ADD --chown=ronin ./ronin-contract-event-plugin/src/main/initializer/.gitignore /usr/local/initializer/.gitignore
